...
int main(int argc, char *argv[]) {
	std::cout<<"Evolver.cpp/begin load conf" << std::endl;
	...
	std::cout<<"Evolver.cpp/begin parse robot and initialize population" << std::endl;
	...
	// ---------------------------------------
	std::cout<<"Evolver.cpp/run TODO/begin to run TODO evolution" << std::endl;
	...
	for (unsigned int generation = 2; generation <= conf->numGenerations;
		...
		// evaluate children
		std::cout<<"Evolver.cpp/run TODO/evaluate children" << std::endl;
		children.evaluate(robotConf, sockets);
		std::cout<<"Evolver.cpp/run TODO/children evaluated" << std::endl;
