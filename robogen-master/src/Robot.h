...
public:
	...
	boost::shared_ptr<Model> & getCam(){return Cam;}
	
	std::vector<boost::shared_ptr<Motor> > getMotor(){return motors_;}
...
private:
	...
	boost::shared_ptr<Sensor> Camera;
