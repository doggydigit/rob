...
void protobuf_AssignDesc_robogen_2eproto() {
  ...
  static const int SimulatorConf_offsets_[8] = {
...
void protobuf_AddDesc_robogen_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ight\030\003 \002(\002\"Y\n\006Neuron\022\n\n\002id\030\001 \002(\t\022\r\n\005laye"
    "r\030\002 \002(\t\022\022\n\nbiasWeight\030\003 \001(\002\022\022\n\nbodyPartI"
    "d\030\004 \001(\t\022\014\n\004ioId\030\005 \001(\005\"e\n\005Brain\022&\n\006neuron"
    "\030\001 \003(\0132\026.robogenMessage.Neuron\0224\n\nconnec"
    "tion\030\002 \003(\0132 .robogenMessage.NeuralConnec"
    "tion\"]\n\005Robot\022\n\n\002id\030\001 \002(\005\022\"\n\004body\030\002 \002(\0132"
    "\024.robogenMessage.Body\022$\n\005brain\030\003 \002(\0132\025.r"
    "obogenMessage.Brain\"\271\001\n\010Obstacle\022\t\n\001x\030\001 "
    "\002(\002\022\t\n\001y\030\002 \002(\002\022\t\n\001z\030\003 \002(\002\022\r\n\005xSize\030\004 \002(\002"
    "\022\r\n\005ySize\030\005 \002(\002\022\r\n\005zSize\030\006 \002(\002\022\017\n\007densit"
    "y\030\007 \002(\002\022\021\n\txRotation\030\010 \002(\002\022\021\n\tyRotation\030"
    "\t \002(\002\022\021\n\tzRotation\030\n \002(\002\022\025\n\rrotationAngl"
    "e\030\013 \002(\002\"6\n\rStartPosition\022\t\n\001x\030\001 \002(\002\022\t\n\001y"
    "\030\002 \002(\002\022\017\n\007azimuth\030\003 \002(\002\"\363\001\n\rSimulatorCon"
    "f\022\024\n\014terrainWidth\030\001 \002(\002\022\025\n\rterrainLength"
    "\030\002 \002(\002\022+\n\tobstacles\030\003 \003(\0132\030.robogenMessa"
    "ge.Obstacle\022\020\n\010scenario\030\004 \002(\t\022\031\n\021lightSo"
    "urceHeight\030\005 \002(\002\022\020\n\010timeStep\030\006 \002(\002\022\022\n\nnT"
    "imeSteps\030\007 \002(\005\0225\n\016startPositions\030\010 \003(\0132\035"
    ".robogenMessage.StartPosition\"o\n\021Evaluat"
    "ionRequest\022$\n\005robot\030\001 \002(\0132\025.robogenMessa"
    "ge.Robot\0224\n\rconfiguration\030\002 \002(\0132\035.roboge"
    "nMessage.SimulatorConf\"C\n\020EvaluationResu"
    "lt\022\n\n\002id\030\001 \002(\005\022\017\n\007fitness\030\002 \002(\002\022\022\n\nobjec"
    "tives\030\003 \003(\002", 1411);
...
const EvolvableParameter& EvolvableParameter::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_robogen_2eproto();  return *default_instance_;
}
...
const int Neuron::kBiasWeightFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_biasWeight;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_bodyPartId;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_ioId;
        break;
      }
...
void Neuron::SerializeWithCachedSizes(
  ...
  // optional float biasWeight = 3;
  if (has_biasweight()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->biasweight(), output);
  }
  ...
  if (has_bodypartid()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
      ...
      ::google::protobuf::internal::WireFormat::SERIALIZE);
    ::google::protobuf::internal::WireFormatLite::WriteString(
      4, this->bodypartid(), output);
  }
  
  // optional int32 ioId = 5;
  if (has_ioid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(5, this->ioid(), output);
  }
...
::google::protobuf::uint8* Neuron::SerializeWithCachedSizesToArray(
  ...
  // optional float biasWeight = 3;
  if (has_biasweight()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(3, this->biasweight(), target);
  }
  ...
  if (has_bodypartid()) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        4, this->bodypartid(), target);
  }
  
  // optional int32 ioId = 5;
  if (has_ioid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(5, this->ioid(), target);
  }
...
void Neuron::MergeFrom(const Neuron& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_biasweight()) {
      set_biasweight(from.biasweight());
    }
...
void Neuron::Swap(Neuron* other) {
  if (other != this) {
    ...
    std::swap(biasweight_, other->biasweight_);
...
bool SimulatorConf::IsInitialized() const {
  ...
  for (int i = 0; i < startpositions_size(); i++) {
    if (!this->startpositions(i).IsInitialized()) return false;
  }
  return true;
}
